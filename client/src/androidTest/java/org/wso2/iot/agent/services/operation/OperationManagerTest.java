...
public class OperationManagerTest {
    ...
    public JSONObject generatePayload(String fileUrl,String userName, String password, String fileLocation) {
        JSONObject payload = new JSONObject();
        try {
            payload.put(org.wso2.iot.agent.utils.Constants.FileTransfer.FILE_URL, fileUrl);
            payload.put(org.wso2.iot.agent.utils.Constants.FileTransfer.PASSWORD, password);
            payload.put(org.wso2.iot.agent.utils.Constants.FileTransfer.USER_NAME, userName);
    ...
    public void testDownloadFileFTPClientFileLocationSpecified() {
        ...
        testDownloadFile(generatePayload(fileUrl, Constants.USER_NAME,Constants.PASSWORD, downloadDirectory));
    }

    @Test
    public void testDownloadFileFTPClientNoUserName() {
        String fileUrl = Constants.FTP_SCHEME + Constants.USER_NAME + Constants.LOCAL_HOST +
                Constants.FTP_PORT + File.separator + Constants.DOWNLOAD_FILE_NAME;
    ...
    public void testDownloadFileFTPClientFileLocationNotSpecified() {
        ...
        testDownloadFile(generatePayload(fileUrl,Constants.USER_NAME, Constants.PASSWORD, ""));
    }
    ...
    public void testUploadFileFTPClient() {
        ...
        testUploadFile(generatePayload(fileUrl,Constants.USER_NAME, Constants.PASSWORD, fileLocation));
    }

	...
	private void registerFCM() {
		...
		if(token != null) {
			...
			progressDialog = CommonDialogUtils.showProgressDialog(RegistrationActivity.this,
					...
					null);
			Log.i(TAG, "FCM registration initiated.");
			FirebaseInstanceId.getInstance().getInstanceId()
					.addOnSuccessListener(RegistrationActivity.this, new OnSuccessListener<InstanceIdResult>() {
						@Override
				...
				public void onFailure(@NonNull Exception e) {
					Log.w(TAG, "Registration Id is not available during enrollment.", e);
